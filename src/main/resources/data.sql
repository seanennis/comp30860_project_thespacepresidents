...
INSERT INTO artifacts(name, type, onLoan, owner, reserved, reserver) VALUES('Harry Potter 1', 'Book', TRUE, 1, FALSE, null);
INSERT INTO artifacts(name, type, onLoan, owner, reserved, reserver) VALUES('Harry Potter 2', 'Book', TRUE, 1, FALSE, null);
INSERT INTO artifacts(name, type, onLoan, owner, reserved, reserver) VALUES('Harry Potter 3', 'Book', FALSE, null, FALSE, null);
INSERT INTO artifacts(name, type, onLoan, owner, reserved, reserver) VALUES('Harry Potter 4', 'Book', FALSE, null, FALSE, null);
INSERT INTO artifacts(name, type, onLoan, owner, reserved, reserver) VALUES('Harry Potter 5', 'Book', FALSE, null, FALSE, null);
